...
template<typename T>
void check_unserialize(const char * str)
{
	T v;
	serialization::json_oarchive oa;
	try
	{
		...
		serialization::json_iarchive ia;
		ia.load_data(str);
		serialization::unserialize(ia, v);
...
TEST(test_json, test_int)
{
	test_integer<TestInt>();
}

TEST(test_json, test_uint)
{
	test_integer<TestUint>();
}

TEST(test_json, test_int32)
{
	test_integer<TestInt32>();
}

TEST(test_json, test_uint32)
{
	test_integer<TestUint32>();
}

TEST(test_json, test_int64)
{
	test_integer<TestInt64>();
}

TEST(test_json, test_uint64)
{
	test_integer<TestUint64>();
}

TEST(test_json, test_double)
{
	TestDouble a,b;
